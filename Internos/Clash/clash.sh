...
echo -e "🦎” Cargando Configuracion del Repositorio Original Lulseck"
...
echo -e "\033[1;37m      ã€      Lulseck-ADM Mods. VPSPack      ã€‘\033[0m"
...
- name: "Lulseck-ADM"
  ...
  proxies:
    ...
    #- Trojan🇪🇨_Public3_v-4
######----- SnellPublic Lulseck
#######----- Socks  V2rayUC Lulseck
########----- ShadowsocksPublic Lulseck
...
rules:
- DOMAIN-SUFFIX,local,Lulseck-ADM
- DOMAIN-SUFFIX,google.com,Lulseck-ADM
- DOMAIN-KEYWORD,google,Lulseck-ADM
- DOMAIN,google.com,Lulseck-ADM
- DOMAIN-SUFFIX,ad.com,Lulseck-ADM
- SRC-IP-CIDR,192.168.1.201/32,Lulseck-ADM
- IP-CIDR,127.0.0.0/8,Lulseck-ADM
- GEOIP,IR,Lulseck-ADM
- MATCH, Lulseck-ADM
