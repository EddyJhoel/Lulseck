...
cd socks
patch="https://raw.githubusercontent.com/EddyJhoel/Lulseck/master/Internos/Ray/backsocz"
arq="backsocz"
...
screen -dmS getpy python ${SCPinst}/PGet.py -b "0.0.0.0:$1" -p "${SCPinst}/pwd.pwd"
 ...
 echo -e "Gettunel Iniciado com Sucesso"
 msg -bar
 echo -ne "Sua Senha Gettunel e :"
 echo -e "\033[1;32m NetVPS"
 msg -bar
 } || echo -e "Gettunel nao foi iniciado"
 msg -bar
}
...
echo -e "\033[1;32m INSTALADOR SOCKS - Mod V4.1"
msg -bar
...
echo -e "${cor[4]} [7] > \033[1;36m  DETENER TODOS SOCKS PYTHON"
echo -e "${cor[4]} [0] > \033[1;37m VOLVER"
msg -bar
IP=(meu_ip)
