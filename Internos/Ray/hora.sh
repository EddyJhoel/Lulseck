...
unset opx
echo -e " \033[1;36m ZONA HORARIO \033[1;32m[Lulseck]"
echo -e "$barra"
while true; do
echo -e "${cor[4]} [1] > ${cor[5]}ACTUALIZAR HORARIO Local America/Chihuahua"
echo -e "${cor[4]} [2] > ${cor[5]}ACTUALIZAR HORARIO Local America/Lima (Perú)"
...
echo -e "${cor[4]} [9] > ${cor[5]}ACTUALIZAR HORARIO  America/Ecuador "
