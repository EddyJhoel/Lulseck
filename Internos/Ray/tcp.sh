#!/bin/bash
#19/12/2019
source <(curl -sSL https://raw.githubusercontent.com/EddyJhoel/Lulseck/master/Internos/msg)
clear
msg -bar 
...
clear
msg -bar
echo -e " TCP Aceleración (BBR/Plus) - Lulseck ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
$(msg -bar)
